...
pkgdatadir = $(datadir)/intercal
pkgincludedir = $(includedir)/intercal
pkglibdir = $(libdir)/intercal
pkglibexecdir = $(libexecdir)/intercal
...
DIST_COMMON = README $(am__configure_deps) $(dist_ickdata_DATA) \
	...
	$(top_srcdir)/buildaux/configh.in \
	$(top_srcdir)/buildaux/hostmak.in $(top_srcdir)/configure \
	$(top_srcdir)/src/abcessh.in $(top_srcdir)/src/cooptsh.in \
...
CONFIG_CLEAN_FILES = coopt.sh host.mak abcess.h
...
ACLOCAL = ${SHELL} /home/Intercal-SDL/buildaux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/Intercal-SDL/buildaux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/Intercal-SDL/buildaux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/Intercal-SDL/buildaux/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/Intercal-SDL/buildaux/missing --run makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = intercal
PACKAGE_BUGREPORT = ais523(with a (comment))@nethack4.org
PACKAGE_NAME = C-INTERCAL
PACKAGE_STRING = C-INTERCAL 0.30
...
YACC = bison -y
YFLAGS = 
abs_builddir = /home/Intercal-SDL
abs_srcdir = /home/Intercal-SDL
abs_top_builddir = /home/Intercal-SDL
abs_top_srcdir = /home/Intercal-SDL
ac_ct_AR = ar
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/Intercal-SDL/buildaux/install-sh
...
# installed.
BUILT_SOURCES = parser.h ick-wrap.c pickwrap.c syslib.i syslib3.3i syslib4.4i \
                syslib5.5i syslib6.6i syslib7.7i floatlib.i ecto_b98.c \
		ick_ec.h fiddle.h ick_bool.h ick_lose.h yuk.h
...
EXTRA_DIST = pit etc BUGS src/abcessh.in src/feh.h src/fiddle.h src/ick_ec.h \
             ...
             doc/THEORY.txt doc/tidy.cfg parser.c parser.h lexer.c control \
             doc/ick.txi doc/ick.txt doc/chipspec.txt HISTORY NEWS README \
...
stamp-h1: $(top_srcdir)/buildaux/configh.in $(top_builddir)/config.status
	@rm -f stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status config.h
$(top_srcdir)/buildaux/configh.in:  $(am__configure_deps) 
...
host.mak: $(top_builddir)/config.status $(top_srcdir)/buildaux/hostmak.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
abcess.h: $(top_builddir)/config.status $(top_srcdir)/src/abcessh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
libick.a: $(libick_a_OBJECTS) $(libick_a_DEPENDENCIES) $(EXTRA_libick_a_DEPENDENCIES) 
	-rm -f libick.a
	$(libick_a_AR) libick.a $(libick_a_OBJECTS) $(libick_a_LIBADD)
	$(RANLIB) libick.a
libickec.a: $(libickec_a_OBJECTS) $(libickec_a_DEPENDENCIES) $(EXTRA_libickec_a_DEPENDENCIES) 
	-rm -f libickec.a
	$(libickec_a_AR) libickec.a $(libickec_a_OBJECTS) $(libickec_a_LIBADD)
	$(RANLIB) libickec.a
libickmt.a: $(libickmt_a_OBJECTS) $(libickmt_a_DEPENDENCIES) $(EXTRA_libickmt_a_DEPENDENCIES) 
	-rm -f libickmt.a
	$(libickmt_a_AR) libickmt.a $(libickmt_a_OBJECTS) $(libickmt_a_LIBADD)
	$(RANLIB) libickmt.a
libyuk.a: $(libyuk_a_OBJECTS) $(libyuk_a_DEPENDENCIES) $(EXTRA_libyuk_a_DEPENDENCIES) 
	-rm -f libyuk.a
...
convickt$(EXEEXT): $(convickt_OBJECTS) $(convickt_DEPENDENCIES) $(EXTRA_convickt_DEPENDENCIES) 
...
ick$(EXEEXT): $(ick_OBJECTS) $(ick_DEPENDENCIES) $(EXTRA_ick_DEPENDENCIES) 
	@rm -f ick$(EXEEXT)
...
cesspool.o: src/cesspool.c
	...
	$(am__mv) $(DEPDIR)/cesspool.Tpo $(DEPDIR)/cesspool.Po
...
numerals.o: src/numerals.c
	...
	$(am__mv) $(DEPDIR)/numerals.Tpo $(DEPDIR)/numerals.Po
...
ick_lose.o: src/ick_lose.c
	...
	$(am__mv) $(DEPDIR)/ick_lose.Tpo $(DEPDIR)/ick_lose.Po
...
fiddle.o: src/fiddle.c
	...
	$(am__mv) $(DEPDIR)/fiddle.Tpo $(DEPDIR)/fiddle.Po
...
arrgghh.o: src/arrgghh.c
	...
	$(am__mv) $(DEPDIR)/arrgghh.Tpo $(DEPDIR)/arrgghh.Po
...
clc-cset.o: src/clc-cset.c
	...
	$(am__mv) $(DEPDIR)/clc-cset.Tpo $(DEPDIR)/clc-cset.Po
...
uncommon.o: src/uncommon.c
	...
	$(am__mv) $(DEPDIR)/uncommon.Tpo $(DEPDIR)/uncommon.Po
...
ick_ec.o: src/ick_ec.c
	...
	$(am__mv) $(DEPDIR)/ick_ec.Tpo $(DEPDIR)/ick_ec.Po
...
unravel.o: src/unravel.c
	...
	$(am__mv) $(DEPDIR)/unravel.Tpo $(DEPDIR)/unravel.Po
...
yuk.o: src/yuk.c
	...
	$(am__mv) $(DEPDIR)/yuk.Tpo $(DEPDIR)/yuk.Po
...
convickt.o: src/convickt.c
	...
	$(am__mv) $(DEPDIR)/convickt.Tpo $(DEPDIR)/convickt.Po
...
feh2.o: src/feh2.c
	...
	$(am__mv) $(DEPDIR)/feh2.Tpo $(DEPDIR)/feh2.Po
...
dekludge.o: src/dekludge.c
	...
	$(am__mv) $(DEPDIR)/dekludge.Tpo $(DEPDIR)/dekludge.Po
...
perpet.o: src/perpet.c
	...
	$(am__mv) $(DEPDIR)/perpet.Tpo $(DEPDIR)/perpet.Po
...
lexer.c: lexer.l
	 \
	$(SHELL) $(YLWRAP) `test -f 'lexer.l' || echo '$(srcdir)/'`lexer.l $(LEX_OUTPUT_ROOT).c lexer.c -- $(LEX) $(AM_LFLAGS) $(LFLAGS)
...
parser.c: parser.y
	 \
	$(SHELL) $(YLWRAP) `test -f 'parser.y' || echo '$(srcdir)/'`parser.y y.tab.c parser.c y.tab.h parser.h y.output parser.output -- $(YACC) $(AM_YFLAGS) $(YFLAGS)

oil-oil.c: src/oil.y
	 \
	$(am__skipyacc) \
	$(SHELL) $(YLWRAP) `test -f 'src/oil.y' || echo '$(srcdir)/'`src/oil.y y.tab.c oil-oil.c y.tab.h oil-oil.h y.output oil-oil.output -- $(YACC) $(oil_YFLAGS) $(YFLAGS)
doc/$(am__dirstamp):
	@$(MKDIR_P) doc
	@: > doc/$(am__dirstamp)
...
install-dist_ickdataDATA: $(dist_ickdata_DATA)
	@$(NORMAL_INSTALL)
	@list='$(dist_ickdata_DATA)'; test -n "$(ickdatadir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(ickdatadir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(ickdatadir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(ickdatadir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(ickdatadir)" || exit $$?; \
	done
...
uninstall-dist_ickdataDATA:
	...
	@list='$(dist_ickdata_DATA)'; test -n "$(ickdatadir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(ickdatadir)'; $(am__uninstall_files_from_dir)
install-nodist_ickdataDATA: $(nodist_ickdata_DATA)
	@$(NORMAL_INSTALL)
	@list='$(nodist_ickdata_DATA)'; test -n "$(ickdatadir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(ickdatadir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(ickdatadir)" || exit 1; \
	fi; \
...
install-ickincludeHEADERS: $(ickinclude_HEADERS)
	@$(NORMAL_INSTALL)
	@list='$(ickinclude_HEADERS)'; test -n "$(ickincludedir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(ickincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(ickincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	...
	while read files; do \
	  echo " $(INSTALL_HEADER) $$files '$(DESTDIR)$(ickincludedir)'"; \
	  $(INSTALL_HEADER) $$files "$(DESTDIR)$(ickincludedir)" || exit $$?; \
	done
...
uninstall-ickincludeHEADERS:
	...
	@list='$(ickinclude_HEADERS)'; test -n "$(ickincludedir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(ickincludedir)'; $(am__uninstall_files_from_dir)
install-nodist_ickincludeHEADERS: $(nodist_ickinclude_HEADERS)
	@$(NORMAL_INSTALL)
	@list='$(nodist_ickinclude_HEADERS)'; test -n "$(ickincludedir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(ickincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(ickincludedir)" || exit 1; \
	fi; \
...
check-am: ick$(EXEEXT)
	...
	make -f $(top_srcdir)/pit/Makefile ICK="./ick$(EXEEXT) -b" PIT=$(top_srcdir)/pit test
...
release: intercal-$(VERSION).tar.gz
	shipper -u -t; rm -f *.tar.gz *.tar.bz2 *.lzma SHIPPER.*
	cd website; upload
